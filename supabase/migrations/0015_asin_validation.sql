-- =============================================================================
-- 0015  Remove ASIN 10-digit format constraint.
--
-- Drops products_asin_code_shape check constraint on public.products and
-- updates admin_create_product and admin_update_product RPCs to remove the
-- 10-character regex requirement. ASIN becomes fully optional free-text.
-- =============================================================================

alter table public.products drop constraint if exists products_asin_code_shape;
